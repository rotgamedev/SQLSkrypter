const translations = {
    en: {
        // Navigation
        nav_core: "Overview", nav_features: "Features", nav_license: "Licensing", nav_changelog: "Changelog", nav_download: "Download", nav_faq: "FAQ",
        ...
        f2_h: "ScriptDom Validation & Dry Run", f2_p: "Integrated Microsoft ScriptDom AST parser blocks destructive queries during discovery. Safely simulate transaction rollbacks on production with Dry-Run mode.",
        f3_h: "Advanced Workspace", f3_p: "Hierarchical server trees with drag-and-drop support, drag-and-drop file sorting, color-coded environment tagging, and seamless session state persistence.",
    ...
    pl: {
        // Navigation
        nav_core: "Przegląd", nav_features: "Funkcje", nav_license: "Licencjonowanie", nav_changelog: "Changelog", nav_download: "Pobierz", nav_faq: "FAQ",
        ...
        f2_h: "ScriptDom i Dry Run", f2_p: "Zintegrowany analizator składniowy Microsoft ScriptDom blokuje niebezpieczne operacje podczas ładowania. Bezpiecznie testuj zapytania (rollback) używając trybu Dry-Run na produkcji.",
        f3_h: "Zaawansowany Interfejs", f3_p: "Drzewo serwerów z pełnym wsparciem drag & drop, oznaczanie środowisk kolorami, swobodne sortowanie plików oraz natychmiastowe odzyskiwanie sesji.",
        ...
        fc1_1_h: "Wydajny Silnik Równoległy", fc1_1_p: "Uruchamiaj zapytania na wielu środowiskach. Konfiguruj limit wątków i przerywaj wykonywanie w każdym momencie.",
        ...
        r1_f: "Limit Serwerów", r1_std: "Do 10 Serwerów", r1_pro: "Nielimitowany",
        r2_f: "Grupy Środowisk", r2_std: "Do 3 Grup", r2_pro: "Nielimitowane",
        r3_f: "Egzekucja Równoległa", r4_f: "Symulacja Dry-Run", r5_f: "Zapis/Odczyt Sesji", r6_f: "Eksport Konfiguracji (AES)",
        r7_f: "Prawo do Użytku", r7_std: "Prywatnie, Nauka", r7_pro: "Brak Ograniczeń (Komercja)",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!initialLang) {
        ...
        initialLang = userLang.startsWith('pl') ? 'pl' : 'en';
    }
    ...
    // 2. Mouse Glow Spotlight, Custom Cursor & Magnetic Buttons
